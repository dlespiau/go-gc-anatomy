...
NOTE: It seems there's a will to get rid of the `gc` AST in favour of the
`syntax` one (https://go-review.googlesource.com/c/40693/[source]) and
eliminate one of the tree representations.
